...
3. Check that your SDK version supports this board. See the [release notes](#) for supported boards.
...
"For a complete list of error codes, see the [nrfx error codes reference](#)."
