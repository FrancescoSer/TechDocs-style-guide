...
## Use lists instead of long compound sentences

When a sentence contains three or more items, conditions, or steps, convert it into a list. Lists are faster to scan and easier to follow.

**Long compound sentence:**

"The nRF52840 supports Bluetooth Low Energy for short-range communication, Thread for mesh networking in smart home applications, and Zigbee for interoperability with existing smart home ecosystems."
...
* Thread for mesh networking in smart home applications
* Zigbee for interoperability with existing smart home ecosystems"

See [Lists](../content-structure/lists.md) for formatting guidelines.
