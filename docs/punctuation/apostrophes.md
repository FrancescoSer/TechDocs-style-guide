...
| **To indicate a missing letter in a contraction** | cannot</br> do not</br> it is  |
...
|-----------|-----------|----------|
| **For the possessive form of *it*** | Replace a formula with **it is** calculated value. | Replace a formula with **its** calculated value. |
