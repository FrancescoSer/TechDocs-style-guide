...
| Situation | Examples |
|-----------|----------|
| **A range of numbers (no units)**</br> Use a closed en dash (no spaces). For ranges *with* units, use *to* instead of a dash so the dash is not read as minus or subtraction; repeat the unit for each number and use plus or minus when it avoids ambiguity. | 2015–2017</br> 5–10 files</br></br> **With units:** from -40°C to 100°C</br> from -3 dBm to +20 dBm |
...
| **To join the following prefixes with the main compound word:**</br> all, ex, quasi, self| all-encompassing</br> ex-president</br> quasi-static</br> self-aware|
...
Compound modifiers (usually hyphenated when preceding a noun)

| Single Adjectives </br>(Noun + Verb + Modifier) | Compound Adjectives | Comments |
| ----------------------------------------- | ------------------- | -------- |
| The address has 16 bits.</br>It consists of 5 bits. | a 16-bit address</br>a 5-bit sequence | |
