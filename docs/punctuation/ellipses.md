...
## Do not use an ellipses

**Do not** use an ellipses in the following situations.

| Situation | Incorrect | Correct  |
|-----------|-----------|----------|
| When there is an ellipsis in UI, do not include it in instructions | Select **Safety...**, and then **Delete browsing history**. | Select **Safety**, and then **Delete browsing history**. |
