...
The search terms that customers use are not necessarily the same terms you would use when searching. So before you write, identify the keywords that you think customers will use to find your content. These resources can help:
...
* Write short link text (four or fewer words) that is descriptive and includes keywords.
...
Never create backlinks just to improve your site's search ranking. Search practices that do not make sense for your content rarely work and often backfire.
